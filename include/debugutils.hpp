...
#ifndef DISABLE_DEBUG_MESSAGING
...
auto DebugMessage([[maybe_unused]] S&& debugLevel, [[maybe_unused]] T&& message) -> void {
...
auto DebugMessage(S&& debugLevel, std::format_string<Args...> format, Args&&... args) -> void {
...
template <class S, class... Args>
[[noreturn]] auto ThrowMessage(S&& debugLevel, std::format_string<Args...> format, Args&&... args) -> void {
